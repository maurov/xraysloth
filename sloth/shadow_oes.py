...
class SwOE(object):
    ...
    def set_frame_of_reference(self, p, q, deg_inc, deg_refl=None, deg_mirr=0.):
        ...
        self.sw_oe._oe.setFrameOfReference(p, q, deg_inc, deg_refl, deg_mirr)
    ...
    def set_dimensions(self, fshape=1, params=np.array([0., 0., 0., 0.])):
        ...
        """
        self.sw_oe._oe.setDimensions(fshape, params=params)
...
class PlaneCrystal(SwOE):
    ...
    def set_crystal(self, file_refl, a_bragg=0.0,\
        ...
        self.sw_oe._oe.setCrystal(file_refl=bytes(file_refl, 'utf-8'), a_bragg=a_bragg)

        if tune_auto == 0:
            self.sw_oe._oe.F_CENTRAL = 0
        else:
            self.sw_oe._oe.setAutoTuning(f_phot_cent=tune_units, phot_cent=tune_ev, r_lambda=tune_ang)
    ...
    def set_mosaic(self, mos_seed, angle_spread_FWHM, thickness):
        ...
        """
        self.sw_oe._oe.setMosaic(mosaic_seed=mos_seed, spread_mos=angle_spread_FWHM, thickness=thickness)
    ...
    def set_johansson(self, js_radius):
        ...
        self.sw_oe._oe.R_JOHANSSON = js_radius
